    ...
    <section cclass="bg-grey-50" id="about">
        <div class="mx-auto max-w-screen-xl container flex flex-col items-center py-16 md:py-20 lg:flex-row">
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <h4 class="pt-6 font-header text-xl font-medium text-black sm:text-2xl lg:text-3xl"> about me</h4>
                <div class="flex">
                    <img src="https://i.pinimg.com/236x/51/97/b1/5197b175bcea94d9d22fb18f509529fb.jpg" alt="Circle Image"
                        class="mt-4 rounded-full h-40 w-40">
                    <div class="ml-6">
                        <p class="pt-6 font-body leading-relaxed text-grey-20 text-xl font-bold">Pramudya Anggara Zitha<br>21.11.4266</p>
                    </div>
                </div>
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a href="https://www.instagram.com/angra_zit/"
                            class="font-body text-lg font-semibold uppercase text-grey-20 hover:underline"> Connect with me </a>
            ...
            <div class="w-full pl-0 pt-10 sm:w-3/4 lg:w-2/5 lg:pl-12 lg:pt-0 ">
                <div v-for="item in skill" :key="item.id">
                    ...
                    <div class="mt-2 bg-lila w-full bg-gray-200 rounded-full h-2.5 dark:bg-gray-700 mb-5">
